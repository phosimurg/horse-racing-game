...
2. Red: delegate the tests to the `test-author` agent and show the author every assertion before writing implementation code.
...
5. Review: run the `code-reviewer` agent on the diff and resolve or explicitly reject each finding.
