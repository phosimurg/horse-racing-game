...
- The VoiceOver pass stayed with the author, since a screen reader cannot be driven from this environment. They ran the script in `docs/audits.md` on 2026-09-16 and reported no issues.
