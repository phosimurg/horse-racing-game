...
| HRG-22 | Program generation with simulations                    | PROG-01, PROG-02, PROG-03         | `src/domain/race/generateProgram.spec.ts`                               | [x]    |
| HRG-23 | Round simulation, placements, progress and calibration | RACE-04, RES-01                   | `simulateRound.spec.ts`, `rankPlacements.spec.ts`, `progressAt.spec.ts` | [x]    |
