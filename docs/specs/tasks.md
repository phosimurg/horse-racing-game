...
| HRG-22 | Program generation with simulations                    | PROG-01, PROG-02, PROG-03, NFR-03 | `src/domain/race/generateProgram.spec.ts`                               | [x]    |
| HRG-23 | Round simulation, placements, progress and calibration | RACE-02, RACE-04, RES-01          | `simulateRound.spec.ts`, `rankPlacements.spec.ts`, `progressAt.spec.ts` | [x]    |
| HRG-24 | Playback reducer                                       | RACE-01, RACE-03, RACE-05, RES-02 | `src/domain/race/advancePlayback.spec.ts`                               | [x]    |
| HRG-25 | Stryker configuration and mutation workflow            |                                   | Planted mutant reported Killed; score of at least 80                    | [x]    |
...
| HRG-33 | Animation frame and race playback composables                      | RACE-01, RACE-02, RACE-03, RACE-05                  | `useAnimationFrame.spec.ts`, `useRacePlayback.spec.ts`              | [x]    |
| HRG-34 | Theme, media query and announcer composables                       | UX-02, UX-03, NFR-01                                | `useTheme.spec.ts`, `useMediaQuery.spec.ts`, `useAnnouncer.spec.ts` | [x]    |
...
| ID     | Task                                                                                  | Requirements                           | Tests                                               | Status |
| ------ | ------------------------------------------------------------------------------------- | -------------------------------------- | --------------------------------------------------- | ------ |
| HRG-40 | Design approval from desktop and mobile screenshots of the running app (no canvas)    | UX-01, UX-02, UX-03, NFR-01            | Owner approval                                      | [x]    |
...
| HRG-44 | Dashboard view components                                                             | PROG-04, RACE-02, RES-01, UX-01, UX-03 | `src/views/RaceDashboard/RaceDashboardView.spec.ts` | [x]    |
...
| ID     | Task                                              | Requirements                         | Tests                  | Status |
| ------ | ------------------------------------------------- | ------------------------------------ | ---------------------- | ------ |
| HRG-60 | Visual specs and 10 baselines                     | RACE-02, RES-01, UX-01, UX-02, UX-03 | `e2e/visual/*.spec.ts` | [x]    |
